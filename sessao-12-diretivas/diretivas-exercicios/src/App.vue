<template>
	<div id="app">
		...
		<hr>
		<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'green', cor2: 'yellow', atraso: 1000, intervalo: 200}">Usando diretiva personalizada</p>
		<p v-destaque-local.atrasar="{cor1: 'blue', atraso: 3000}">Usando diretiva personalizada</p>
	</div>
</template>
